        ...
        <section className="lg:mb-20 mb-4 md:mb-16">
          ...
          <div className="flex flex-wrap pt-14">
            <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
              ...
              <button
                type="button"
                className="mb-6 inline-block w-full rounded bg-[#253046] px-6 py-2.5 font-medium uppercase leading-normal btn text-white hover:shadow-md hover:bg-[#253046]"
              >
                Send
              </button>
            </form>
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500 ">support@elysian.com</p>
                      <p className="text-neutral-500 ">+8 234-367-85</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500 ">sales@elysian.com</p>
                      <p className="text-neutral-500 ">+3 234-567-87</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500 ">press@elysian.com</p>
                      <p className="text-neutral-500 ">+1 204-587-89</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500 ">bugs@elysian.com</p>
                      <p className="text-neutral-500">+1 224-567-99</p>
                    </div>
                  </div>
                </div>
              </div>
