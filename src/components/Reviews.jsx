    ...
    <div className=" mt-10 px-6">
      <div className="bg-[#F5F6F7] ">
        <div className=" pl-8 max-w-6xl md:text-left  mx-auto  border-l-[3px] border-[#BA9230]">
          <h4 className="lg:text-base text-sm md:text-base pb-4 font-bold text-[#BA9230] tracking-[4px]">
            Reviews
          </h4>
          <h2 className="font-bold md:text-3xl text-2xl lg:text-4xl tracking-tight text-slate-900 sm:text-4xl">
                    ...
                    <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                      ...
                      <blockquote className="relative">
                        <p className="text-lg tracking-tight text-slate-900">
                          ...
                          Estates and couldnt be happier with the outcome.
                        </p>
                      </blockquote>
                      <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                        <div>
